...
pub const RENDEZVOUS_SERVERS: &[&str] = &["shamcalai.micraftsp.com"];
pub const PUBLIC_RS_PUB_KEY: &str = "8F9zL+d48eHqmaxl3lfoghvTpgoRkoGkBnt5sWht9rM=";
...
pub const RENDEZVOUS_PORT: i32 = 22106;
pub const RELAY_PORT: i32 = 22107;
